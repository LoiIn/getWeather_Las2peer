...
import i5.las2peer.services.getWeatherService.GetWeatherMainClass;
...
public class ServiceTest {
		...
		private static final String mainPath = "weather/";
		...
		public void startServer() throws Exception {
			...
			node.startService(new ServiceNameVersion(GetWeatherMainClass.class.getName(), "1.0.0"), "a pass");
